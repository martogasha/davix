...
Route::resource('productInfo','ProductTwoDetailController');
Route::resource('productDetails','ProductDetailsController');
Route::resource('cart','CartController');
Route::resource('cartO','CartOneController');
Route::resource('cartView','CartTwoController');
...
Route::get('cartR/{id}','CartOneController@removeItem');
Route::resource('checkout','CheckoutController');
Route::get('shop','CategoryController@all');
Route::get('shopCartegory','CategoryOneController@all');
Route::get('shopNow','CategoryTwoController@all');
...
Route::resource('internetOne','InternetOneController');
