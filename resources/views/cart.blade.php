                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ul class="header-top-right text-right">
                            ...
                            <li class="sitemap"><a href="#">Sitemap</a></li><li class="cart"><a href="cart_page.html">My Cart</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-sm-8 col-md-8 col-lg-9 mtb_30">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    <a href="" style="padding-left: 13px">+</a>
                                    <div style="max-width: 35px;" class="input-group btn-block">
                                        <input class="form-control" value="1" name="quantity" disabled>
                                    </div>
                                    <a href="" style="padding-left: 13px">-</a>

                                </td>
                                <td class="text-right">Ksh:254.00</td>
                                <td class="text-right">Ksh:254.00</td>
                            </tr>
                            </tbody>
                        </table>
                ...
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-8">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td class="text-right"><strong>Sub-Total:</strong></td>
                                <td class="text-right">Ksh:210.00</td>
                            </tr>
                            <tr>
                                <td class="text-right"><strong>Eco Tax (-2.00):</strong></td>
                                <td class="text-right">Ksh:2.00</td>
                            ...
                            <tr>
                                <td class="text-right"><strong>VAT (20%):</strong></td>
                                <td class="text-right">Ksh:42.00</td>
                            </tr>
                            <tr>
                                <td class="text-right"><strong>Total:</strong></td>
                                <td class="text-right">Ksh:254.00</td>
                ...
                <form action="http://html.lionode.com/fastro/f001/index.html">
                    <input class="btn pull-left mt_30" type="submit" value="Continue Shopping" />
                </form>
                <form action="http://html.lionode.com/fastro/f001/checkout.html">
