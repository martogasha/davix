...
<!-- Mirrored from htmldemo.net/rozer/rozer/single-product-affiliate.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Mar 2025 12:06:54 GMT -->
<head>
        <meta charset="utf-8" />
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets1/images/favicon/favicon.png')}}" />
        <!-- Google Fonts -->
                                ...
                                <li class="pr-0">
                                    <div class="dropdown">
                                        <button type="button" id="dropdownMenuButton-3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <img src="{{asset('assets1/images/flag/1.jpg')}}" alt="" /> English <i class="ion-ios-arrow-down"></i>
                                        </button>

                                        <ul class="dropdown-menu animation slideDownIn" aria-labelledby="dropdownMenuButton-3">
                                            <li>
                                                <a href="#"><img src="{{asset('assets1/images/flag/1.jpg')}}" alt="" /> English</a>
                                            </li>
                                            <li>
                                                <a href="#"><img src="{{asset('assets1/images/flag/2.jpg')}}" alt="" /> Français</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
            ...
            <div class="header-top bg-white ptb-30px d-xl-block d-none">
                <div class="container">
                    <div class="row">
                        <div class="col-md-2">
                            <div class="logo">
                                <a href="{{url('internet')}}"><img class="img-responsive" src="{{asset('assets1/images/logo/L.jpg')}}" alt="logo.jpg" /></a>
                            </div>
                        </div>
                                ...
                                <ul class="menu-content display-none">
                                    <li class="menu-item">
                                        ...
                                        <ul class="sub-menu flex-wrap">
                                            ...
                                            <li>
                                                <img src="{{asset('assets1/images/menu-image/banner-mega1.jpg')}}" alt="" />
                                            </li>
                                        </ul>
                                        <!-- sub menu -->
                                    </li>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('assets1/images/product-image/7.jpg')}}" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('assets1/images/product-image/9.jpg')}}" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('assets1/images/product-image/8.jpg')}}" alt="Cart product Image"></a>
                        <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="breadcrumb-content">
                            <ul class="nav">
                                <li><a href="{{url('internet')}}">Home</a></li>
                            ...
                            <div class="product-details-img product-details-tab">
                                <div class="zoompro-wrap zoompro-2">
                                    <div class="zoompro-border zoompro-span">
                                        <img class="zoompro" src="{{asset('uploads/product/'.$product->product_image1)}}" alt="" />
                                    </div>
                                </div>
                                <div id="gallery" class="product-dec-slider-2 swiper-container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a class="active" data-image="{{asset('uploads/product/'.$product->product_image1)}}">
                                                <img class="img-responsive" src="{{asset('uploads/product/'.$product->product_image1)}}" alt="" />
                                            </a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a data-image="{{asset('uploads/product/'.$product->product_image1)}}">
                                                <img class="img-responsive" src="{{asset('uploads/product/'.$product->product_image1)}}" alt="" />
                                            </a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a data-image="{{asset('uploads/product/'.$product->product_image1)}}" data-zoom-image="{{asset('uploads/product/'.$product->product_image1)}}">
                                                <img class="img-responsive" src="{{asset('uploads/product/'.$product->product_image1)}}" alt="" />
                                            </a>
                                        </div>
                                        <div class="swiper-slide">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="product-details-content">
                                ...
                                <div class="pricing-meta">
                                    <ul>
                                        <li class="old-price not-cut">Ksh {{$product->product_price}}</li>
                                    </ul>
                                </div>
                                ...
                                <button type="submit" class="btn btn-info">ADD TO CART</button>
                                    <a href="{{url('shopCartegory')}}" class="btn btn-info">CONTINUE SHOPPING</a>
                                ...
                                <div class="pro-details-policy">
                                    <ul>
                                        <li><img src="{{asset('assets1/images/icons/policy.png')}}" alt="" /><span>Security Policy (Edit With Customer Reassurance Module)</span></li>
                                        <li><img src="{{asset('assets1/images/icons/policy-2.png')}}" alt="" /><span>Delivery Policy (Edit With Customer Reassurance Module)</span></li>
                                        <li><img src="{{asset('assets1/images/icons/policy-3.png')}}" alt="" /><span>Return Policy (Edit With Customer Reassurance Module)</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="review-wrapper">
                                            <div class="single-review">
                                                <div class="review-img">
                                                    <img src="{{asset('assets1/images/review-image/1.png')}}" alt="" />
                                                </div>
                                            ...
                                            <div class="single-review child-review">
                                                <div class="review-img">
                                                    <img src="{{asset('assets1/images/review-image/2.png')}}" alt="" />
                                                </div>
                                                <div class="review-content">
                                                    <div class="review-top-wrap">
                                                        <div class="review-left">
                    ...
                    <div class="feature-slider-wrapper swiper-wrapper">
                            ...
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/6.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/7.jpg')}}" alt="" />
                                    </a>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/7.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/8.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/9.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/10.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/12.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/13.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/14.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/15.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/16.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/17.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/18.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/19.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/20.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/21.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/22.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/23.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/24.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/25.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/26.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/27.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/28.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/29.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/8.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/9.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="{{asset('assets1/images/product-image/10.jpg')}}" alt="" />
                                        <img class="second-img" src="{{asset('assets1/images/product-image/11.jpg')}}" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-end">
                                <img class="payment-img" src="{{asset('assets1/images/icons/payment.png')}}" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-5 col-sm-12 col-xs-12 mb-lm-100px mb-sm-30px">
                                 <!-- Swiper -->
                                  <div class="swiper-container gallery-top">
                                        <div class="swiper-wrapper">
                                          <div class="swiper-slide"> 
                                                <img class="img-responsive m-auto" src="{{asset('assets1/images/product-image/11.jpg')}}" alt="">
                                          </div>
                                          <div class="swiper-slide"> 
                                                <img class="img-responsive m-auto" src="{{asset('assets1/images/product-image/12.jpg')}}" alt="">
                                          </div>
                                          <div class="swiper-slide"> 
                                                <img class="img-responsive m-auto" src="{{asset('assets1/images/product-image/13.jpg')}}" alt="">
                                          </div>
                                          <div class="swiper-slide"> 
                                                <img class="img-responsive m-auto" src="{{asset('assets1/images/product-image/14.jpg')}}" alt="">
                                          </div>
                                        </div>
                                  </div>
...
============================================ -->
        ...
        <!-- Use the minified version files listed below for better performance and remove the files listed above -->
        <script src="{{asset('assets1/js/vendor/vendor.min.js')}}"></script>
        <script src="{{asset('assets1/js/plugins/plugins.min.js')}}"></script>
