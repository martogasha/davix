                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="input-email" placeholder="Phone" value="" name="phone">
                                        </div>
                                        <div class="form-group">
                                            <label for="input-email" class="control-label">Location</label>
                                            <input type="text" class="form-control" id="input-email" placeholder="Location" value="" name="location">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">Ksh:1,000.00</td>
                                                <td class="text-right">Ksh:1,000.00</td>
                                            </tr>
                                            </tbody>
                                            <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">Ksh:5.00</td>
                                            </tr>
                                            <tr>
                                                <td class="text-right" colspan="4"><strong>Total:</strong></td>
                                                <td class="text-right">Ksh:1,005.00</td>
                                            </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="buttons">
                                    <div class="pull-right mt_20">I have read and agree to the <a class="agree" href="#"><b>Terms &amp; Conditions</b></a>
                                        ...
                                        &nbsp;
                                        <input type="button" class="btn" data-loading-text="Loading..." id="button-payment-method" value="Place Order">
                                    </div>
                                </div>
